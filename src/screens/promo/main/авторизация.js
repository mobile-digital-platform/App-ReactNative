		...
		return (
				<View>
					<View style={styles.container1}>
						...
						<Input placeholder="Мобильный телефон" style={{ marginTop: 25, marginBottom: 25 }}/>
						<Input placeholder="Пароль" style={{marginBottom: 25 }}/>
						<Button1 value="Войти" />
					</View>
					<View style={styles.container2}>
						<Text style={[styles.text, {textAlign: 'center'}]}>Я забыл пароль</Text>
						<Button1 value="восстановить пароль" style={{ marginTop: 25, marginBottom: 25 }} />
					</View>
				</View>
		)
	}
